...
END:VCARD
    ...
    conn.reply = (jid, text = '', quoted, options) => {
        let a = ['tqto', '1', '2', '4', 'esce', 'ku', 'shiraori']
        let b = a[Math.floor(Math.random() * a.length)]
        return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, jpegThumbnail: fs.readFileSync('./media/4.jpg'), contextInfo: {
    externalAdReply :{
    sourceUrl: `https://wa.me/+994407430641`,
    previewType: "PHOTO",
    title: `${global.wm}\nKlik Disini Untuk Chat Owner`,
