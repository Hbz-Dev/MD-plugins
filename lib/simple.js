...
END:VCARD
    ...
    conn.reply = (jid, text = '', quoted, options) => {
        return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, jpegThumbnail: fs.readFileSync('./media/su.jpg'), text }, { quoted, ...options })
    }
...
const buttonMessage = {
    image: {url: buffer},
    jpegThumbnail: fs.readFileSync('./media/su.jpg'),
    caption: content,
    footer: footer,
    buttons: buttons,
    headerType: 1
