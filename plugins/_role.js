                                                                                                                                        ...
                                                                                                                                        : ((user.level >= 97) && (user.level <= 100)) ? 'Mythic II'
                                                                                                                                           : ((user.level >= 100) && (user.level <= 105)) ? 'Mythic I'      
                                                                                                                                              : ((user.level >= 105) && (user.level <= 120)) ? 'Mythical glory'
                                                                                                                                                 : ((user.level >= 120) && (user.level <= 150)) ? 'Mythical Legendary'
                                                                                                                                                    : ((user.level >= 150) && (user.level <= 160)) ? 'Great Mythical Human'
                                                                                                                                                        : ((user.level >= 160) && (user.level <= 170)) ? 'Mythical Demon'
                                                                                                                                                            : ((user.level >= 170) && (user.level <= 185)) ? 'Mythical Demon Lord'
                                                                                                                                                                : ((user.level >= 185) && (user.level <= 200)) ? 'Mythical Angel'
                                                                                                                                                                    : ((user.level >= 200) && (user.level <= 400)) ? 'Mythical True Angel'
                                                                                                                                                                        : ((user.level >= 405) && (user.level <= 700)) ? 'Lord Of The World'
                                                                                                                                                                            : ((user.level >= 700) && (user.level <= 1000)) ? 'Lord Of The Galaxy'
                                                                                                                                                                                : 'Lord Of Everthing'
