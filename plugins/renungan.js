let handler = async(m, { conn }) => {
  await conn.sendButtonImg(m.chat, pickRandom(global.renungan), 'Nih renunganmu, jangan lupa dijadikan pelajaran yah buat masa depan nanti...', wm, 'Renungan', '.renungan', m)
}
